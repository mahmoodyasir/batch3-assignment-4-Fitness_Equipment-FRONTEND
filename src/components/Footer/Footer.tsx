      ...
      <footer className=' bg-amber-50 pt-12 px-4 md:px-8 lg:px-12 pb-24' >
        ...
        <div className='flex flex-wrap justify-between gap-4 mt-12'>
          ...
          <section className=' flex flex-col gap-6'>
            <Typography variant='h4' className='font-alegreya whitespace-nowrap'>Service</Typography>
            <button onClick={() => navigate('/products')} className='w-fit'>Product</button>
            <button onClick={() => navigate('/product_management')} className='w-fit'>Product Management</button>
          </section>
          ...
          <section className='flex flex-col gap-6' >
            ...
            <Typography><b>Email:</b> fitgym@gmail.com</Typography>
